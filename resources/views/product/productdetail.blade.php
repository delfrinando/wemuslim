                                        ...
                                        <div class="simpleLens-container">
                                            <div class="simpleLens-big-image-container"><a
                                                        ...
                                                        class="simpleLens-lens-image"><img
                                                            src="{{URL::asset('img/view-slider/medium/polo-shirt-1.png')}}"
                            ...
                            <div class="col-md-7 col-sm-7 col-xs-12">
                                <div class="aa-product-view-content">
                                    ...
                                    <div class="aa-price-block">
                                        <span class="aa-product-view-price">Rp. {{$product->price}}</span>

                                        <p class="aa-product-avilability">Avilability: <span>{{$product->stock}}</span></p>
                                    </div>
                                                ...
                                                <div class="media-left">
                                                    <a href="#">
                                                        <img class="media-object"
                                                             src="{{URL::asset('img/testimonial-img-3.jpg')}}"
                                                             alt="girl image">
                                                    </a>
                                                </div>
                    ...
                    {{--<div class="aa-product-related-item">--}}
                        ...
                        {{--<ul class="aa-product-catg aa-related-item-slider">--}}
                            ...
                            {{--<li>--}}
                                {{--<figure>--}}
                                    {{--<a class="aa-product-img" href="#"><img--}}
                                                {{--src="{{URL::asset('img/man/polo-shirt-2.png')}}"--}}
                                                {{--alt="polo shirt img"></a>--}}
                                    {{--<a class="aa-add-card-btn" href="#"><span class="fa fa-shopping-cart"></span>Add To--}}
                                        {{--Cart</a>--}}
                                    {{--<figcaption>--}}
                                        {{--<h4 class="aa-product-title"><a href="#">Polo T-Shirt</a></h4>--}}
                                        {{--<span class="aa-product-price">$45.50</span><span class="aa-product-price"><del>--}}
                                                {{--$65.50--}}
                                            {{--</del></span>--}}
                                    {{--</figcaption>--}}
                                {{--</figure>--}}
                            ...
                            {{--<li>--}}
                                {{--<figure>--}}
                                    {{--<a class="aa-product-img" href="#"><img--}}
                                                {{--src="{{URL::asset('img/man/t-shirt-1.png')}}" alt="polo shirt img"></a>--}}
                                    {{--<a class="aa-add-card-btn" href="#"><span class="fa fa-shopping-cart"></span>Add To--}}
                                        {{--Cart</a>--}}
                                {{--</figure>--}}
                                {{--<figcaption>--}}
                            ...
                            {{--<li>--}}
                                {{--<figure>--}}
                                    {{--<a class="aa-product-img" href="#"><img--}}
                                                {{--src="{{URL::asset('img/man/polo-shirt-1.png')}}"--}}
                                                {{--alt="polo shirt img"></a>--}}
                                    {{--<a class="aa-add-card-btn" href="#"><span class="fa fa-shopping-cart"></span>Add To--}}
                                        {{--Cart</a>--}}
                                    {{--<figcaption>--}}
                            ...
                            {{--<li>--}}
                                {{--<figure>--}}
                                    {{--<a class="aa-product-img" href="#"><img--}}
                                                {{--src="{{URL::asset('img/man/polo-shirt-4.png')}}"--}}
                                                {{--alt="polo shirt img"></a>--}}
                                    {{--<a class="aa-add-card-btn" href="#"><span class="fa fa-shopping-cart"></span>Add To--}}
                                        {{--Cart</a>--}}
                                    {{--<figcaption>--}}
